...
public class koneksi {
    private String jdbcUrl="jdbc:mysql://localhost:3306/19630206";  //untuk menampung URL dan Database/koneksi ke databse
    ...
    public void SaveStaticAdminStatement(String user, String pass, String lvl){ //menggunakan library statement
        try{
            String SQL="INSERT INTO user(username, password, level) VALUES ('"+user+"','"+pass+"','"+lvl+"')";
